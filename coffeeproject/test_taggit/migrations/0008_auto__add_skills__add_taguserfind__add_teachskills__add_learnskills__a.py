...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'test_taggit_food', (
            ...
            ('teach', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['test_taggit.TeachSkills'], null=True)),
            ('learn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['test_taggit.LearnSkills'], null=True)),
        ))
